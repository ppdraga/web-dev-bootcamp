...
mongoose.connect("mongodb://mongo:mongo@localhost:27017/blogDB", {useNewUrlParser: true, useUnifiedTopology: true});
// login to mongo shell
// use blogDB
// db.createUser({user: 'mongo', pwd: 'mongo', roles: [ { role: 'readWrite', db: 'blogDB'} ]});
